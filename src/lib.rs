...
pub trait Mapping<TypeData>{
    fn get_data(filename: &str) -> TypeData;
    fn new(filename: &str) -> Self;
    fn algebra(maps: HashMap<&str, f32>) -> Self;
}

impl Mapping<Array2<f32>> for Raster<f32>
{
    fn get_data(filename: &str) -> Array2<f32>{
...
mod test_approx {
    ...
    #[test]
    fn test_abs_diff_eq(){
        let raster1 = Raster::new("data/data1.asc");
...
mod test_algebra {
    ...
    fn test_new_data(){
        ...
        let raster1 = Raster::new("data/data1.asc");
        let raster2 = Raster::new("data/data2.asc");
        let raster3 = Raster::new("data/data3.asc");
        let raster4 = Raster::new("data/data4.asc");
        let result = Raster::new("data/result.asc");
    ...
    #[test]
    fn test_new_algebra(){
        let mut maps: HashMap<&str, f32> = HashMap::new();

        maps.insert("data/data1.asc", 0.4);
        maps.insert("data/data2.asc", 0.2);
        maps.insert("data/data3.asc", 0.2);
        maps.insert("data/data4.asc", 0.2);
    ...
    fn test_new_algebra_zero(){
        let maps: HashMap<&str, f32> = HashMap::new();
